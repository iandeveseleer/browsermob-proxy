...
**Get the entries from HAR for a specific proxy and page Ref. *[port]* in request path it is port where your proxy is started.  *[pageRef]* in request path is the page Ref from which you want to get entries** |**GET** |**/proxy/[port]/har/entries/[pageRef]**|**<p>*port* - The port of the proxy from which you want to request the HAR. </p><p>*pageRef* - The string name of the page ref that you want to find in the HAR. </p>**
**Get the entries from HAR for a specific proxy and page Ref which got URL like pattern. *[port]* in request path it is port where your proxy is started.  *[pageRef]* in request path is the page Ref from which you want to get entries. *[pattern]* in request path is the URL's pattern you want from returned entries** |**GET** |**/proxy/[port]/har/entries/[pageRef]/url/[pattern]**|**<p>*port* - The port of the proxy from which you want to request the HAR. </p><p>*pageRef* - The string name of the page ref that you want to find in the HAR. </p><p>*pattern* - The pattern of URL. </p>**
**Remove the Entries and Page from HAR for a specific proxy and page Ref. *[port]* in request path it is port where your proxy is started.  *[pageRef]* in request path is the page Ref from which you want to get entries.** |**DELETE** |**/proxy/[port]/har/entries/pageRef/[pageRef]**|**<p>*port* - The port of the proxy from which you want to request the HAR. </p><p>*pageRef* - The string name of the page ref that you want to find in the HAR. </p>**
